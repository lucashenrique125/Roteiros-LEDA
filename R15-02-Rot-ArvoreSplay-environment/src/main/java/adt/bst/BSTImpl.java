...
public class BSTImpl<T extends Comparable<T>> implements BST<T> {
	...
	public BSTNode<T> sucessor(T element) {
		...
		while (!node.isEmpty() && isRightChild(node, (BSTNode<T>) node.getParent())) {
	...
	protected boolean isRightChild(BSTNode<T> node, BSTNode<T> parent) {
	...
	public BSTNode<T> predecessor(T element) {
		...
		while (isLeftChild(node, (BSTNode<T>) node.getParent()) && !node.isEmpty()) {
			node = (BSTNode<T>) node.getParent();
		}
	...
	protected boolean isLeftChild(BSTNode<T> node, BSTNode<T> parent) {
